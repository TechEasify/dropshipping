...
const SignUpPage = () => {
  ...
  return (
    ...
    //             <div className="w-full surface-card py-5 px-5 sm:px-8 md:w-8 lg:w-12" style={{ borderRadius: '33px' }}>
    //                 <div className="text-center mb-5">
    ...
    //                 </div>
    //                     <div className="field">
    //                         <InputText id="firstName" type="text" value={client.first_name}  onChange={(e) => setClient({...client,first_name: e.target.value})} placeholder="First Name" className={`w-full p-3 ${classNames({ 'p-invalid': !client.first_name })}`}   />
    //                         {error?.first_name && <Message severity="error" text={error.first_name} />}
    //                     </div>
    //                     <div className="field">
    //                         <InputText id="lastname" type="text" value={client.last_name}  onChange={(e) => setClient({...client,last_name: e.target.value})} placeholder="Last Name" className={`w-full p-3 ${classNames({ 'p-invalid': !client.last_name })}`}   />
    //                         {error?.last_name && <Message severity="error" text={error.last_name} />}
    //                     </div>
    //                     <div className="field">
    //                         <InputText id="email" type="text" value={client.email}  onChange={(e) => setClient({...client,email: e.target.value})} placeholder="Email" className={`w-full p-3 ${classNames({ 'p-invalid': !client.email })}`}   />
    //                         {error?.email && <Message severity="error" text={error.email} />}
    //                     </div>
    //                     <div className="field">
    //                         <InputText id="phoneno" type="text" value={client.phone_no}  onChange={(e) => setClient({...client,phone_no: e.target.value})} placeholder="Phone No." className={`w-full p-3 ${classNames({ 'p-invalid': !client.phone_no })}`}   />
    //                         {error?.first_name && <Message severity="error" text={error.phone_no} />}
    //                     </div>
    //                     <div className="field">
    //                         <Password id="password" type="text" value={client.password}  onChange={(e) => setClient({...client,password: e.target.value})} toggleMask placeholder="Password" className="w-full mb-4"inputClassName={`w-full p-3 ${classNames({ 'p-invalid': !client.password })}`}   />
