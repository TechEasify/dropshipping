...
import { Autocomplete, Box, Button, Card, CardContent, CardMedia, Menu, MenuItem, TextField, Typography } from '@mui/material'
...
const columns = [
    ...
    { field: 'product', headerName: 'Product', width: 130, renderCell: (params) => <ProductWithImage {...params} /> },
...
function ProductWithImage(params) {
    return (
        <img src={getImageForProduct(params.row.product)} alt={params.row.product} style={{ width: 40, height: 40 }} />
    );
}
...
function getImageForProduct(product) {
    const productImages = {
        ...
        Lannister: 'https://d46qqg0b6pc82.cloudfront.net/listing_variation_images/attachments/fb5/9e9/3b-/original/FLLF8-2.png',
        Stark: 'https://d46qqg0b6pc82.cloudfront.net/listing_variation_images/attachments/fb5/9e9/3b-/original/FLLF8-2.png',
        Targaryen: 'https://d46qqg0b6pc82.cloudfront.net/listing_variation_images/attachments/fb5/9e9/3b-/original/FLLF8-2.png',
    };
...
function DownloadButton({ id }) {
    ...
    return (
        <>
            <Button className='download-btn' variant="contained" color="primary" onClick={handleClick}>
                Download
            </Button>
            <Menu
                anchorEl={anchorEl}
                                                            ...
                                                            <div className="col-sm-12 col-xs-12">
                                                                <div className="form-group pf-mb-24">
                                                                    ...
                                                                    <input
                                                                        ...
                                                                        className="form-control inspectletIgnore"
                                                                    />
                                                                    {error.companyname && <div className="error-message">{error.companyname}</div>}
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div className="col-sm-12 col-xs-12">
                                                                <div className="form-group pf-mb-24">
                                                                    ...
                                                                    <input
                                                                        ...
                                                                        className="form-control inspectletIgnore"
                                                                    />
                                                                    {error.Reginumber && <div className="error-message">{error.Reginumber}</div>}
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div className="col-sm-12 col-xs-12">
                                                                <div className="form-group pf-mb-24">
                                                                    ...
                                                                    <input
                                                                        ...
                                                                        className="form-control inspectletIgnore"
                                                                    />
                                                                    {error.address1 && <div className="error-message">{error.address1}</div>}
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div className="col-sm-12 col-xs-12">
                                                                <div className="form-group pf-mb-24">
                                                                    ...
                                                                    <Autocomplete
                                                                        ...
                                                                        autoHighlight
                                                                        disabled={!active}
                                                                        value={countries.find((c) => c.code === state.country) || null}
                                                            ...
                                                            <div className="col-sm-12 col-xs-12">
                                                                <div className="form-group pf-mb-24">
                                                                    ...
                                                                    <input
                                                                        ...
                                                                        className="form-control inspectletIgnore"
                                                                    />
                                                                    {error.postal_code && <div className="error-message">{error.postal_code}</div>}
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                        ...
                        <CustomTabPanel value={value} index={2}>
                            <div className='Membership-information'>
                                <div className='inner-Membership'>
                                    ...
                                    <p>This section contains information about your membership with Jubilee.</p>
                                </div>
                                <div className='main-join'>
                                    ...
                                    <div className='sell-more'>
                                        <h6>Sell more with <span>Pro Plan</span> </h6>
                                        <div className='selling'>
                                            <img className='selling-img' src='https://app.jubilee.beauty/packs/media/assets/icons/user_icons-f324e37ebc8e0fb7e6688062c561e737.svg' />
                                ...
                                <Card sx={{ maxWidth: 345 }} className='plan-card'>
                                    ...
                                    <div className='plan-li'>
                                        <div className='inner-plan'>
                                            <img className='mark-img' src='https://app.jubilee.beauty/packs/media/assets/images/tickgreen-32e0283e6e061cd598e00df64d211616.png' />
